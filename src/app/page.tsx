...
const REASONS = [
  {
    ...
    overlay:
      "bg-gradient-to-b from-black/90 via-black/70 to-black/50 md:from-black/90 md:via-black/70",
...
const CASES = [
  ...
  {
    name: "안산사동점(11평)",
    before: "/images/사동점before.jpg",
    after: "/images/사동점after.jpg",
    memo: "리모델 2,700 + 설비증설 1,000 + 기물 1,000",
    total: "시설 5,950만 / 총 7,950만",
  },
  {
    name: "안양박달점(15평)",
    before: "/images/박달동before.jpg",
    after: "/images/박달동after.jpg",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <Shell>
          <h2
            className={`text-3xl md:text-4xl font-bold mb-3 ${titleClass} text-[#FF9C00]`}
          >
            {title}
          </h2>
          {subtitle && (
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <p className="leading-7 text-[#3b342c]">
              ...
              <br />
              가맹사업을 시작하여 현재 8개이상의 가맹점이 활발히 영업 중입니다.
              <br />
              양념소갈비, 남녀노소에게 모두 사랑받는 메뉴로
              <br />
              쉬운 운영과 최적화된 동선으로 누구나 쉽게 운영가능하며
              <br />
              ...
              ? {
                  ...
                  subtitle: (
                    <span className="text-white">
                      전통방식으로 조리? 특제 육수와 특제 소스? 정성을 다해서 끓이는 노력?
                      <br />
                      이런 건 어디든지 다 하는 겁니다.
                      <br />
                      화려한 미사여구는 빼고 담백하게 창업자가 알아야 할
                      <br />
                      진짜 여상수의 장점을 알려드립니다.
                    </span>
                  ),
      ...
      >
        <ol className="flex flex-wrap gap-5">
          {[
            ...
            <li
              key={step}
              className="inline-flex items-center gap-4 px-6 py-4 rounded-2xl bg-black/55 backdrop-blur-sm ring-1 ring-white/20 shadow-md w-fit"
            >
              <span className="grid place-items-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#e36f33] text-white text-base md:text-lg font-extrabold shrink-0">
                {i + 1}
              </span>
